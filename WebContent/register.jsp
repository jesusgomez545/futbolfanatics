...
<body class="custom-body">	
	...
	<div class="jumbotron">
		<h3 class="text-primary">Registrar</h3>
	</div>
	...
	<td><input type="file" accept="image/*" class="image-register-field" src="" required/></td>
	</tr>
	...
	<button type="submit" class="btn btn-primary modify-button">Registrarse</button>
	</form>			    
